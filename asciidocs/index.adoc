...
create or replace trigger AUDIT_SAL
    ...
    for each row
BEGIN
INSERT INTO emp_audit VALUES (user, sysdate, :old.sal, :new.sal, :new.empno);
END;
/
----

.Disable trigger afterwards
[source, sql]
----
alter trigger AUDIT_SAL disable;
----

== 2. Test

* Packages kommen nicht
* Übung Wawi ist gut vergleichbar was zum Test kommt, (allerdings ohne Package)